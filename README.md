...
* 🌐 **Akıllı Tarım Yönetim Sistemi (IoT):** Sensör verilerini anlık izleyen ve React Native mobil uygulamasıyla entegre çalışan web tabanlı yönetim paneli.
* 🏨 **Tıbbi Otomasyon Sistemi:** Modern UI prensipleriyle doktorlar için geliştirilmiş hasta ve randevu yönetim otomasyonu.
* 🐍 **Java OOP Snake Game:** Nesne Yönelimli Programlama ve GUI temelini pekiştiren klasik yılan oyunu uygulaması.

> *Daha fazla detay ve canlı demolar için [web sitemi](https://miracozcanagcabay.com) ziyaret edebilirsiniz.*
